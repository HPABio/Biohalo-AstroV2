import { Gemini } from '@workspace/components/ui/svgs/gemini'
import { Replit } from '@workspace/components/ui/svgs/replit'
import { MagicUI } from '@workspace/components/ui/svgs/magic-ui'
import { VSCodium } from '@workspace/components/ui/svgs/vs-codium'
import { MediaWiki } from '@workspace/components/ui/svgs/media-wiki'
import { GooglePaLM } from '@workspace/components/ui/svgs/google-palm'
import { LogoIcon } from '@workspace/components/logo'
            ...
            <div className="bg-muted dark:bg-background py-24 md:py-32">
                <div className="mx-auto max-w-5xl px-6">
                    ...
                    <div className="mx-auto mt-6 max-w-lg space-y-6 text-center">
                        ...
                        <Button variant="outline" size="sm" render={<Link href="#" />} nativeButton={false}>Get Started</Button>
                    </div>
                </div>
            </div>
        </section>
